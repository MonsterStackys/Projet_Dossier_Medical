<x-app-layout>
    ...
    <div class="p-4 sm:p-6">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-xl font-semibold text-gray-800 mb-5">Modifier — {{ $patient->nom_complet }}</h1>
                ...
                <form method="POST" action="{{ route('patients.update', $patient) }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="antecedents" rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 text-sm focus:border-teal-600 focus:ring-teal-600">{{ old('antecedents', $patient->antecedents) }}</textarea>
                    </div>
