<x-app-layout>
    ...
    <div class="p-4 sm:p-6">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-xl font-semibold text-gray-800 mb-5">Nouveau patient</h1>
                ...
                <form method="POST" action="{{ route('patients.store') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="sexe" required class="mt-1 block w-full rounded-md border-gray-300 text-sm focus:border-teal-600 focus:ring-teal-600">
                                <option value="">--</option>
                    ...
                    <div>
                        ...
                        <textarea name="antecedents" rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 text-sm focus:border-teal-600 focus:ring-teal-600">{{ old('antecedents') }}</textarea>
                    </div>

                    <div class="flex justify-end gap-2 pt-2">
                        <a href="{{ route('patients.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Annuler</a>
                        <button type="submit"
